...
@section('title','Data Diri - Inventory')
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Data Diri Inventory</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
            ...
            <div class="card-body pt-3">
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                  ...
                  <!-- Profile Edit Form -->
                  <form action="{{route('Edit.DataInventory',Auth::user()->id)}}" method="post" id="contact-form" enctype="multipart/form-data">	
                    {{ csrf_field() }}
                    {{ method_field('PATCH') }}
                    <div class="row mb-3">
