...
{   
    ...
    public function IndexKeamanan(){
        $re_entry= DB::table('re_entry')->get();
        return view('Keamanan/IndexKeamanan',['re_entry' => $re_entry]);
    }
    public function DataKeamanan(){
        return view('Keamanan/DataKeamanan');
    }
    public function EditDiriKeamanan(Request $request,$id){
